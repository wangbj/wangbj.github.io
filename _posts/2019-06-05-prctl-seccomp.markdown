...
replace it, or allow the user to uninstall previous seccomp rules. But this is not something supported as of today. library like `libseccomp` has function like `seccomp_release`, but as its manage shows, 
